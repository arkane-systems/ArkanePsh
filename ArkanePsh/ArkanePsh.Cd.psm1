...
$forwardStack = new-object System.Collections.ArrayList
...
Set-Alias cd ArkanePsh\Set-LocationEx -Force -Scope Global -Option AllScope -Description "ArkanePsh alias"
...
function Set-LocationEx
{
    ...
    Process
    {
        ...
        # If no input, dump contents of backward and forward stacks
        if (!$aPath)
        {
            # Command to dump the backward & forward stacks
            ""
            "     # Directory Stack:"
            "   --- ----------------"
        ...
        elseif ($aPath -like "-[0-9]*")
        {
            ...
            $forestackSize = $forwardStack.Count
